   ...
   <div class="filter-body">
      <div class="row">
         ...
         <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-0 partB">
            ...
            <!-- <div class="ieuk-vocaddtopic ieuk-ilp-hsb mx-auto"> 
               <a href="javscript:void(0);" class="btn-topic btn"><span> <i class="fa fa-plus" aria-hidden="true"></i> </span>Add Topic</a>
               </div> -->
         </div>
      ...
      <div class="row">
         ...
         <section class="main ieuk-vocabulary col-sm-12">
            <div class="col-12 d-flex justify-content-md-start justify-content-between pt-3 pb-5">
               <a href="{{url('vocabulary_new')}}" class="back-button position-absolute"><i class="fa-solid fa-caret-left"></i> back</a>
               ...
               <a href="{{Session::get('lastTask1')}}"
                  class="btn btn-primary btn-icon new-btn">
            ...
            <!-- /. Management Slider-->
            <div class="ilp-heading align-items-center justify-content-between row pb-0">
            </div>
            <?php 
               // dd(session()->get('model_topic_id'));
               ?>
            <hr class="hr">
            <div class="main__content main-vocab">
               <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                     <div class="row df_1">
                        <div class="col-12 col-lg-5 col-xl-4 vocal-nav">
                           <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                              ...
                              <?php foreach($vocabtopiclist as $i=>$vocabtopic){ 
                                 ...
                                 ?>
                              <a class="nav-link topic__name topic_name_edit h_1 {{$class}}" data-vocabname="<?php echo $vocabtopic['name'];?>" data-vacabid = "<?php echo $vocabtopic['id'];?>" id="v-pills-<?php echo $vocabtopic['id'];?>-tab" data-toggle="pill" href="#v-pills-<?php echo $vocabtopic['id'];?>" role="tab" aria-controls="v-pills-<?php echo $vocabtopic['id'];?>"><?php echo $vocabtopic['name'];?>
                           ...
                           <div class="write-here" style="display:none">
                              ...
                              <form id="my_form" action="{{ URL('vocab_topic_post_new') }}" method="post">
                                 {{ csrf_field() }}
                                 <div class="form-group">
                                    <input type="text" name="topicname" id="topicname" class="form-control" placeholder="Write Here">  
                                    <input type="hidden" id="topicname1" class="form-control" value="<?php echo $vocabtopic['name'];?>">                                          
                                 </div>
                                 <ul class="list-inline">
                                    <li class="list-inline-item">
                                       <!-- <input type="submit"   value="ok"> -->
                                       <button type="submit"   style="border: 0; background: none; outline: none;">
                                       <img src="{{ asset('public/images/icon-green-check.svg') }}" alt="" class="img-fluid">
                                       </button>
                                    </li>
                                 </ul>
                              </form>
                           ...
                           <!-- /. Write Here-->
                           <a href="#"  class="btn btn-primary  btn-block btn-topic">
                           <span>
                           <img src="{{ asset('public/images/icon-circle-plus.svg') }}" alt="" class="img-fluid">
                           </span>Add Topic
                           </a>
                        </div>
                        <?php 
                        ...
                        <?php }
                           ?>
                        <!-- Vocab-topic-left-->
                        <div class="col-12 col-lg-7 col-xl-8 vocal-table" >
                                 ...
                                 <div class="vocab-table-container">
                                    ...
                                    <table class="table table-borderless ieuktable-sline">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <th title="Word" scope="row"><?php echo $voc['word'];?></th>
                  ...
                  <?php foreach($abcdKeys as $key){
                     foreach($abcdWise[$key] as $i=>$voc){
                     	?>
                  <tr>
                  <th scope="row" class="vocab-sorter">
                  <?php if($i == 0){?>
                  ...
                  <a href="#"  onclick="viewvocab('<?php echo  $voc['id']; ?>','view')"><img src="{{ asset('public/images/icon-small-eye.png') }}" alt="" class="" width="26px"> </a>
                  <a href="#"  onclick="viewvocab('<?php echo  $voc['id']; ?>','edit')"><img src="{{ asset('public/images/icon-table-edit.png') }}" alt="" class="" width="21px"> </a>
                  <a href="{{ URL('vocabulary_new')}}?delete_vocabulary=<?php echo $voc['id'];?>" onclick="return confirm('Are you sure you want to delete?')" >
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content">
         <form id="my_form2" action="{{ URL('vocab_post_new') }}" method="post">
            @csrf
            <div class="modal-header">
...
<script type="text/javascript">
   ...
   $('.edit-topic').click(function(){
    		...
    		$('.edit-here').append('<div class="example-text" id = "editBox" >e.g. Family, Work etc..</div>'
    			...
    			+'<img src="{{ asset('public/images/icon-circle-trash.svg') }}" alt="" class="img-fluid"></button></li>'
    			+'<li class="list-inline-item">'
    			+'<button type="button" id="edit_btn" onclick="topic()" style="border: 0; background: none; outline: none;"><img src="{{ asset('public/images/icon-green-check.svg') }}" alt="" class="img-fluid"></button></li></ul></form>');
   });
