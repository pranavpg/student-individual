										...
										<div class="modal-dialog modal-dialog-centered deoModal" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="deoModalTitle"><?php echo $custom_option[0];?></h5>
							...
							<div class="dark-buttons row mb-4">
								...
								?>
									<div class="col-4 mb-4">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#deoModal_<?php echo $practise['id'];?>_<?php echo $coun;?>" class="btn btn-dark" style="display:block; text-align:center;z-index: 1500000;"><?php echo $custom_option[0];?></a>
									</div>
								...
								if( !empty($practise['dependingpractise_answer'][0][1][$key] )){
									...
									foreach($practise['dependingpractise_answer'][0][1][$key] as $k=>$v){
										if( !in_array($value['col_'.$m].' ', $table_header) ){
											// if( !empty($practise['dependingpractise_answer'][0][1][$key][$k]) && $practise['dependingpractise_answer'][0][1][$key][$k]==1 ){
		...
		if(data1["{{$practise['id']}}"]["dependant_practise_task_id"] == "{{request()->segment(3)}}"){
			...
			if(data1["{{$practise['id']}}"]["dependant_practise_id"] !=""  ){
				 ...
				 setTimeout(function(){ 
					 ...
					 if(data1["{{$practise['id']}}"]["typeofdependingpractice"] != "get_questions_and_answers"){
					// 	$(document).find("#blank_table_form_{{$practise['id']}}").html(data1["{{$practise['id']}}"]["prevHTML"]);
					// 	$(document).find("#blank_table_form_{{$practise['id']}}").find("input:hidden.practise_id").val('{{$practise["id"]}}')
					// 	$(document).find("#blank_table_form_{{$practise['id']}}").find('li > button').removeClass('blankTableBtn_'+data1["{{$practise['id']}}"]["dependant_practise_id"]).addClass('blankTableBtn_{{$practise["id"]}}').addClass('sadasd')
					// } else {
