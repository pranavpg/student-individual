...
<!-- 			        <input type="button" class="blankTableBtn_{{$practise["id"]}} btn btn-primary" value="Save" data-is_save="0">
					...
					<ul class="list-inline list-buttons">
					      <li class="list-inline-item"><button type="button" class=" save_btn blankTableBtn_{{$practise["id"]}} btn btn-primary"  data-toggle="modal" data-is_save="0" >Save</button>
					      </li>
					    <li class="list-inline-item"><button type="button" class="submit_btn blankTableBtn_{{$practise["id"]}} btn btn-primary"  data-is_save="1" >Submit</button>
					    </li>
					</ul>
