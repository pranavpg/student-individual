...
// echo '<pre>'; print_r($exploded_question); 
      ...
      <div class="true-false true-false_withoutBefore" id="true_false_{{$practise['id']}}">
        ...
        @foreach($exploded_question as $key => $item)
          <div class="box box-flex align-items-center" ><!-- style="pointer-events:none;"-->
        ...
        <ul class="list-inline list-buttons">
          <li class="list-inline-item">
            <!-- <a href="#!" class="btn btn-primary"
                  ...
                  <input type="button" class="save_btn true_false_ag_btn_{{$practise['id']}} btn btn-primary" value="Save" data-is_save="0">
          </li>
          <li class="list-inline-item">
           <input type="button" class="submit_btn true_false_ag_btn_{{$practise['id']}} btn btn-primary" value="Submit" data-is_save="1">
            ...
            success: function (data) {
              $(".true_false_ag_btn_{{$practise['id']}}").removeAttr('disabled');
                ...
                if(data.success){
					...
					$(".save_true_false_a_g_form_{{$practise['id']}}").find('.alert-success').show().html(data.message).fadeOut(8000);
				} else {
					$(".save_true_false_a_g_form_{{$practise['id']}}").find('.alert-success').hide();
					$(".save_true_false_a_g_form_{{$practise['id']}}").find('.alert-danger').show().html(data.message).fadeOut(8000);
				}
            }
        });
