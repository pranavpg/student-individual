        ...
        <div class="tab-pane fade show active" id="abc-b" role="tabpanel"
            ...
            <p><strong>Write or Paste your url below:</strong></p>
             ...
             <div class="record-video d-flex align-items-end mb-4">
                <b>www.</b>
                <span class="textarea form-control form-control-textarea enter_disable allowpast" role="textbox" contenteditable="" placeholder="Write here...">
                    {{ $answerExists }}
                </span>
            ...
            <li class="list-inline-item">
                <input type="button" class="save_btn record_video_form_{{$practise['id']}} btn btn-primary" value="Save" data-is_save="0">
                </li>
                <li class="list-inline-item">
                <input type="button" class="submit_btn record_video_form_{{$practise['id']}}  btn btn-primary" value="Submit" data-is_save="1">
                </li>
            </ul>
        </div>
</form>
...
if("{{$practise['id']}}" =="15567022325cc96418671f9"){
