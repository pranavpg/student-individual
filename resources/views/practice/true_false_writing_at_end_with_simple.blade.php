<div class="true-false">
									...
									<div class="box box-flex align-items-center">
										<div class="box__left flex-grow-1">
											...
											<div class="form-group">
												...
												?>
												<span style="{{$style}}" class="textarea form-control form-control-textarea notallowspeical stringProper text-left mb-2" role="textbox" contenteditable placeholder="Write here..."><?php if ($answerExists) { if(!empty($answers) && isset($answers[$tempFlag][0][$s]) && isset($answers[$tempFlag][0][$s])){ echo  isset($answers[$tempFlag][0][$s]['text_ans'])?str_replace(" ","&nbsp;",$answers[$tempFlag][0][$s]['text_ans']):""; } }
													?></span>
												<div style="display:none">
													<textarea name="text_ans[{{$c}}][{{$s}}][text_ans]"><?php if ($answerExists) { if(!empty($answers) && isset($answers[$tempFlag][0][$s]) && isset($answers[$tempFlag][0][$s])){ echo  isset($answers[$tempFlag][0][$s]['text_ans'])?str_replace(" ","&nbsp;",$answers[$tempFlag][0][$s]['text_ans']):"";
														} } ?></textarea>
												</div>
											</div>
										</div>
			...
			@if($practise['type'] == "true_false_speaking_writing_simple")
				...
				<div class="form-slider p-0 mb-4">
					<div class="component-control-box">
						<span class="textarea form-control form-control-textarea notallowspeical t_f_simple stringProper text-left" role="textbox" contenteditable placeholder="Write here..."><?php if ($answerExists){ echo  $practise['user_answer'][0]['text_ans'][1][0];}
							?></span>
						<div style="display:none">
							<textarea name="text_ans[1][0]"><?php if ($answerExists) { echo $practise['user_answer'][0]['text_ans'][1][0];}?></textarea>
						</div>
					</div>
				</div>
			@endif
	...
	<div class="true-false">
	          	...
	          	<div class="box__left flex-grow-1">
					...
					@if($practise['type']=='true_false_writing_at_end' || $practise['type']=='true_false_writing_at_end_simple' )
		              	<div class="form-group">
							...
							<span style="{{$style}}" class="textarea form-control form-control-textarea notallowspeical" role="textbox" contenteditable placeholder="Write here..."><?php if ($answerExists) { echo  $answers[0][$key]['text_ans'];} ?></span>
			                <div style="display:none">
			                  <textarea name="text_ans[{{$key}}][text_ans]"><?php if ($answerExists) { echo  $answers[0][$key]['text_ans']; }?></textarea>
			                </div>
		              	</div>
					@endif
	          	</div>
		...
		@if($practise['type'] == "true_false_speaking_writing_simple")
				...
				<div class="form-slider p-0 mb-4">
						<div class="component-control-box">
							<span class="textarea form-control form-control-textarea notallowspeical t_f_simple stringProper text-left" role="textbox" contenteditable placeholder="Write here..."> <?php if ($answerExists) { echo  $practise['user_answer'][0]['text_ans'][1][0]; } ?></span>
							<div style="display:none"> <textarea name="text_ans[1][0]"> <?php if ($answerExists) { echo $practise['user_answer'][0]['text_ans'][1][0];} ?></textarea>
							</div>
						</div>
				</div>
		@endif
