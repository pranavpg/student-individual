...
<?php }?>
        ...
        <input type="button" class="twoBlankTableBtn btn btn-primary" value="Save" data-is_save="0">
        <input type="button" class="twoBlankTableBtn btn btn-primary" value="Submit" data-is_save="1">
...
$(document).on('click','.twoBlankTableBtn' ,function() {
  ...
  setTextareaContent();
  $.ajax({
      url: '<?php echo URL('save-blank-table-three-roleplay'); ?>',
