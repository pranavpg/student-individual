...
<form class="save_upload_ppt_form_{{$practise['id']}}">
    ...
    <div class="record-video d-flex align-items-end mb-5">
        <b>www.</b>
        <span class="textarea form-control form-control-textarea url_textbox allowpast" role="textbox" contenteditable="" placeholder="Write here...">
            {{  $user_answer }}
        </span>
...
if("{{$practise['id']}}" =="15567375945cc9ee3a61c3c"||"15567020835cc9638316ad7"){
