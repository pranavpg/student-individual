    ...
    <p>
        ...
        <form class="save_three_blank_table_form_{{$practise['id']}}">
            ...
            <input type="hidden" class="depend_task_id" name="depend_task_id" value="{{ isset($depend[0]) }}">
            <input type="hidden" class="depend_practise_id" name="depend_practise_id" value="{{ isset($depend[1]) }}">
            ...
            <input type="button" class="save_btn threeBlankTableBtn btn btn-primary" value="Save" data-is_save="0">
            <input type="button" class="submit_btn threeBlankTableBtn btn btn-primary" value="Submit" data-is_save="1">
    ...
    <script type="text/javascript">
                    ...
                    var result = data[0]['text_ans'][0];
                        ...
                        for(var i=0; i< result[0].length; i++)
                        {
                            if(i>0){
                                ...
                                //$('.col_'+i+'_4').html(result[0][i]['col_4']).val(result[0][i]['col_4'])
                            }
                        }
        ...
        setTextareaContent();
        $.ajax({
            url: '<?php echo URL('save_four_blank_table_form'); ?>',
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: 'POST',
