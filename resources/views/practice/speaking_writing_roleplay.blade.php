                        ...
                        <div class="col-12 col-lg-12">
                          ...
                          <span class="textarea form-control form-control-textarea" role="textbox"
                              ...
                              <?php
                                ...
                                {
                                    echo  ($practise['type'] == "speaking_writing_up" || $practise['type'] == "speaking_writing")?$practise['user_answer'][$txtwritingCount]['text_ans']:$practise['user_answer'][0]['text_ans'][0];
                                }
                              ?>
                          </span>
                         ...
                         <input type="hidden" class="deleted_audio_{{$practise['id']}}_{{$txtwritingCount}}" name="single_speaking_writing{{$txtwritingCount}}" value="0">
                      <div class="row w-100 d-flex flex-wrap">
                        <div class="col-12 col-lg-12">
...
<script>
  ...
  // $(document).on('click','.submitBtn1_{{$practise["id"]}}' ,function() {
