...
?>
		...
		?>
			...
			<?php }?>
					...
					<div class="alert alert-danger" role="alert" style="display:none"></div>
					<ul class="list-inline list-buttons">
						<li class="list-inline-item"><button type="button" class="btn btn-primary submitBtn blankTableBtn_dependacy_{{$practise['id']}}" data-pid="{{$practise['id']}}"
								data-toggle="modal" data-is_save="0" data-target="#exitmodal"  >Save</button>
						</li>
						<li class="list-inline-item"><button type="button"
								class="btn btn-primary submitBtn blankTableBtn_dependacy_{{$practise['id']}}" data-pid="{{$practise['id']}}" data-is_save="1" >Submit</button>
						</li>
					</ul>
