				...
				if($practise['type'] == "writing_at_end_four_blanks_table" || $practise['type'] == "writing_at_end_up_four_blanks_table"){
					...
					foreach($exploded_question as $counttt=>$question){
						...
						<div class="form-group form-group-label mb-4">
							...
							<span class="textarea form-control form-control-textarea blank_textarea" role="textbox" contenteditable="" placeholder="Write here...">{{isset($tempPracticeData['user_answer'][1][$counttt]) ? $tempPracticeData['user_answer'][1][$counttt] :''}}</span>
