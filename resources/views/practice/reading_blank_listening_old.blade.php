...
<form class="readingtotalblanks_speakingup_form_{{$practise['id']}}">
    ...
    <div class="simple-list mb-4">
        <ul class="list-unstyled list-decimal" contentEditable="false">
    ...
    <div class="alert alert-danger" role="alert" style="display:none"></div>
        <ul class="list-inline list-buttons">
            <li class="list-inline-item">
                <input type="button" class="readingtotalblanks_speakingupBtn_{{$practise['id']}} btn btn-primary" value="Save" data-is_save="0">
            </li>
            <li class="list-inline-item">
                <input type="button" class="readingtotalblanks_speakingupBtn_{{$practise['id']}} btn btn-primary" value="Submit" data-is_save="1">
            </li>
        </ul>
...
$(document).ready(function()
{
   var maxcounter={{ count($exploded_question) }}
    ...
    var selected_item =''; var selected_color='#D2DBE3';
    owl.owlCarousel({
        loop: false,
        margin: 10,
        pagination: false,
