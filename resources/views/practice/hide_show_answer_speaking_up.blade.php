...
var workerDirPath = "{{asset('public/js/audio-recorder/')}}";
  $( document ).ready(function() {
    var practise_id = $(".form_{{$practise['id']}}").find('.practise_id').val();
    ...
    function getDependingPractise(){
      ...
      $.ajax({
                  ...
                  if(data.question!=null && data.question!=undefined){
                        ...
                        if(data.dependent_user_Answer && data.dependent_user_Answer[0].length>0){
                          ...
                          data.dependent_user_Answer[0].forEach((item, i) => {
                            if(item.trim()!=""){
                                  k++;
                                appendQue +=  `<div class="box box-flex align-items-start">
                                  ...
                                  <div class="true-false_buttons">
                                      <a href="javascript:void(0)" class="btn btn-ShowHide btn-primary ">Show Answer</a>
                                  </div>
                                </div>`;
          ...
          //   $(this).find('.').css("display","block !important")
          // })
          //     alert("asdasd")
