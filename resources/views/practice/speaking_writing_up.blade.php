              ...
              @if(!empty($dv['text_ans']))
                ...
                <div class="form-slider p-0 mb-4">
                  ...
                  <div class="component-control-box">
                    <span class="textarea form-control form-control-textarea spandata-temp fillblanks enter_disable" role="textbox" contenteditable placeholder="Write here...">
                      <p>eeee</p>
                        <?php
                          if ($answerExists)
                          {
        ...
        ?>
            ...
            @if(!empty(trim($value)))
              <div class="form-slider p-0 mb-4">
                ...
                <div class="component-control-box">
                  <span class="textarea form-control form-control-textarea spandata-temp fillblanks enter_disable" role="textbox"
      ...
      if(data1["{{$practise['id']}}"]["dependant_practise_task_id"] == "{{request()->segment(3)}}"){
        ...
        if(data1["{{$practise['id']}}"]["dependant_practise_id"] !=""  ){
          //setTimeout(function(){
            ...
            if( data1["{{$practise['id']}}"]["typeofdependingpractice"]=="set_full_view_remove_zero"){
              //  alert(data1["{{$practise['id']}}"]["dependant_practise_id"]);
        ...
        function (dataHTML, textStatus, jqXHR) {  // success callback
          if(  data1["{{$practise['id']}}"]["dependant_practise_id"]!==undefined ){
            ...
            $(document).find(".showPreviousPractice_"+data1["{{$practise['id']}}"]["dependant_practise_id"]).html(data1["{{$practise['id']}}"]["prevHTML"]);
            $(document).find(".showPreviousPractice_"+data1["{{$practise['id']}}"]["dependant_practise_id"]).css('pointer-events','none');
            $(document).find(".showPreviousPractice_"+data1["{{$practise['id']}}"]["dependant_practise_id"]).find('ul.list-buttons, .alert, .audio-player').remove();

            if(data1["{{$practise['id']}}"]["typeofdependingpractice"]=="set_full_view_remove_zero" || data1["{{$practise['id']}}"]["typeofdependingpractice"] == "set_full_view_remove_zero_get_single_audio"){
