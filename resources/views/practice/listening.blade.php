...
<!--------------ADD DEPENDENT TWO COLUMN TABLE--------->
  ...
  @endif
<!----------------------------------------------------->
<form class="save_listening_form_{{$practise['id']}}" style="{!!$style!!}">
    ...
    <!--------add satic condtion for listening not working -->
   @if($practise['id'] == "16656595856347f2c118a12" OR $practise['id'] == "16656582166347ed680398e" OR $practise['id'] == "1665746850634947a2c6a5f")
  ...
  <ul class="list-inline list-buttons">
    <li class="list-inline-item">
        <input type="button" class="save_btn btnsavelistening_{{$practise['id']}} btn btn-primary" value="Save" data-is_save="0">
    </li>
    <li class="list-inline-item">
        <input type="button" class="submit_btn btnsavelistening_{{$practise['id']}} btn btn-primary" value="Submit" data-is_save="1">
    </li>
  </ul>
</form>
<script>
