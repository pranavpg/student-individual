...
?>
	   ...
	   <script type="text/javascript">
	    ...
	    <script type="text/javascript">
			...
			data28["{{$practise['id']}}"]= {"dependentpractice_ans": "{{$data[$practise['id']]['dependentpractice_ans']}}" };
			data28["{{$practise['id']}}"]["isRolePlayPractice"] = "{{$data[$practise['id']]['isRolePlayPractice']}}"
			data28["{{$practise['id']}}"]["is_dependent"] = "{{$data[$practise['id']]['is_dependent']}}"; 
			if(data28["{{$practise['id']}}"]["is_dependent"]==1){
				
				if(data28["{{$practise['id']}}"]["dependentpractice_ans"]==0 ){
