...
<form class="form_{{$practise['id']}}">
                    ...
                    if($value != ""){
                      ?>
                        ...
                        <div class="col-12 col-lg-12">
                          ...
                          <span class="textarea form-control form-control-textarea stringProper text-left" role="textbox" contenteditable placeholder="Write here..."><?php if($answerExists && isset($practise['user_answer'][$txtwritingCount]['text_ans'])){echo($practise['type'] == "writing_at_end_speaking_multiple" || $practise['type'] == "speaking_writing")?$practise['user_answer'][$txtwritingCount]['text_ans']:$practise['user_answer'][0]['text_ans'][0];}?></span>
                          <div style="display:none">
                                              <textarea name="user_answer[{{$txtwritingCount}}][text_ans]">
                                              <?php
                                                    if ($answerExists && isset($practise['user_answer'][$txtwritingCount]['text_ans']))
                                                    {
                                                      echo($practise['type'] == "speaking_writing_up" || $practise['type'] == "speaking_writing" )?$practise['user_answer'][$txtwritingCount]['text_ans']:'';
                                                    }
                                                ?>
                                              </textarea>
                          </div>
                          ...
                          <input type="hidden" name="user_answer[{{$txtwritingCount}}][path]" class="audio_path{{$txtwritingCount}}" value="">
                      ...
                      <div class="row w-100 d-flex flex-wrap">
                        <div class="col-12 col-lg-12">
                          @include('practice.common.audio_record_div',['key'=>$txtwritingCount])
                        </div>
                      </div>
                      <?php
					}else{
						?>
					  <input type="hidden" name="user_answer[{{$txtwritingCount}}]"  value="#">
					<?php
					  }
    ...
    <ul class="list-inline list-buttons">
        <li class="list-inline-item"><button type="button" class="save_btn btn btn-primary speakingMultipleBtn_{{$practise['id']}}"
                data-pid="{{$practise['id']}}" data-toggle="modal" data-is_save="0"
                data-target="#exitmodal">Save</button>
        </li>
        <li class="list-inline-item"><button type="button" class="submit_btn btn btn-primary submitBtn speakingMultipleBtn_{{$practise['id']}}"
                data-pid="{{$practise['id']}}" data-is_save="1">Submit</button>
        </li>
    </ul>
</form>
<script>
