	...
	<?php }?>
			...
			<?php }?>
					...
					<ul class="list-inline list-buttons">
						<li class="list-inline-item"><input type="button" class="save_btn blankTableBtn_{{$practise["id"]}} btn btn-primary" value="Save" data-is_save="0"></li>
						<li class="list-inline-item"><input type="button" class="submit_btn blankTableBtn_{{$practise["id"]}} btn btn-primary" value="Submit" data-is_save="1"></li>
					</ul>
		...
		$(document).on('click','.blankTableBtn_{{$practise["id"]}}' ,function() {
			...
			if(markingmethod =="student_self_marking"){
				...
				if($(this).attr('data-is_save') == '1') {
				    ...
				    var fullView= $("#blank_table_form_{{$practise['id']}}").clone();
...
?>
		...
		?>
			...
			<?php }?>
					...
					<div class="alert alert-danger" role="alert" style="display:none"></div>
					<ul class="list-inline list-buttons">
						<li class="list-inline-item"><input type="button" class="save_btn blankTableBtn_dependacy_{{$practise["id"]}} btn btn-primary" value="Save" data-is_save="0"></li>
						<li class="list-inline-item"><input type="button" class="submit_btn blankTableBtn_dependacy_{{$practise["id"]}} btn btn-primary" value="Submit" data-is_save="1"></li>
					</ul>
					<input type="hidden" name="table_type" value="<?php echo $columnCount; ?>" />
				</form>
	    </div>
