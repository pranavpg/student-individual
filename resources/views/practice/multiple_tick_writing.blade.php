      ...
      <div class="alert alert-danger" role="alert" style="display:none"></div>
        <ul class="list-inline list-buttons">
            ...
            <!-- <a href="#!" class="btn btn-primary"
                ...
                <input type="button" class="save_btn multiple_tick_writing_Btn_{{$practise['id']}} btn btn-primary" value="Save" data-is_save="0">
            </li>
            <li class="list-inline-item">
            <input type="button" class="submit_btn multiple_tick_writing_Btn_{{$practise['id']}} btn btn-primary" value="Submit" data-is_save="1">
