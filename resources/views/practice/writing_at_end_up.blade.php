...
<?php //$practise['answer_key']= ''; echo '<pre>'; dd($practise);   ?>
<?php
       ...
       ?>
        ...
        if(str_contains($item,'@@')) {
                    ...
                    echo '<div class="writing_at_end_upform-group-label" >'.$outValue = preg_replace_callback('/@@/',
                            ...
                            $str = '</label><textarea type="text" class="form-control writing_at_end_up_form-control enter_disable" name="writeingBox[]" id="writeingBox_'.$w.'" placeholder="Write here..."  value="'.$data.'" rows="1">'.$data.'</textarea>';
                            // $str .= '</span>';
                            $str .='</div><br>';
                                ...
                                <div class="content-box multiple-choice s-button-box selected_option_description selected_option_description_{{$key}} d-none" id="s-button-{{$key.''.$key}}">
                                    ...
                                    <br>                                  
                                        ...
                                        <p>
                                            <div class="form-slider p-0 mb-4">
                                                <div class="component-control-box">
                                                    <span class="textarea form-control form-control-textarea set_full_view_main stringProper text-left test_1" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer'][$roleplayKey]) && $answerExists == true ? nl2br($practise['user_answer'][$roleplayKey]) : ''!!}</span>
                                                    <input type="hidden" name="writeingBox[]" value="">
    ...
    @else
        @if(isset($practise['typeofdependingpractice']))
            ...
            @if(($practise['typeofdependingpractice'] === 'set_full_view_remove_zero'|| $practise['typeofdependingpractice'] ==="set_full_view" ) && $practise['type'] == 'Writing' )
                ...
                <p style="display: none;" id="set_full_view">
                    <div class="form-slider p-0 mb-4">
                        <div class="component-control-box">
                            <span class="textarea form-control form-control-textarea set_full_view stringProper text-left" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? nl2br($practise['user_answer']) : ''!!}</span>
                ...
                @if(isset($practise['dependingpractise_answer'][0]) && !empty($practise['dependingpractise_answer'][0]))
                    ...
                    @endif
                        <p>                    
                            <div class="form-slider p-0 mb-4">
                                <div class="component-control-box">
                                    <span class="textarea form-control form-control-textarea  stringProperNew" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? $practise['user_answer'] : ''!!}</span>
            ...
            <p>                    
                            <div class="form-slider p-0 mb-4">
                                <div class="component-control-box">
                                    <span class="textarea form-control form-control-textarea set_full_view_main stringProper text-left test_2" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? nl2br($practise['user_answer']) : ''!!}</span>
                                    <input type="hidden" name="writeingBox" value="{{ isset($practise['user_answer']) && $answerExists == true ? $practise['user_answer'] : ''  }}">
                                </div>
                            </div>
                        </p>
        ...
        @else
            ...
            @endif
                <div class="form-slider p-0 mb-4">
                    <div class="component-control-box">
                        <span class="textarea form-control form-control-textarea set_full_view_main stringProper text-left test_3" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? nl2br($practise['user_answer']) : ''!!}</span>
                        <input type="hidden" name="writeingBox" value="{{ isset($practise['user_answer']) && $answerExists == true ? $practise['user_answer'] : ''  }}">
                    </div>
                </div>
            </p>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fas fa-file-alt"></i> Article</h4>
            ...
            if(data1["{{$practise['id']}}"]["dependant_practise_id"] !=""  ){
                setTimeout(function(){ 
                    ...
                    if( data1["{{$practise['id']}}"]["typeofdependingpractice"]=="set_full_view_remove_zero"){
                        ...
                        if(data1["{{$practise['id']}}"]["dependant_practise_question_type"] == "set_in_order_vertical_listening") {
