	...
	<div class="two-click-content w-100">
		<?php foreach($rolePlayUsers as $c=>$rolePlayUser){
			...
			<div class="audio-player">
				<audio preload="auto" controls src="<?php echo $practise['audio_file'];?>" type="audio/mpga" id="audio_{{$practise['id']}}"></audio>
			</div>
			<?php }?>
			...
			<div class="table m-auto">
					...
					<div class="table-row thead-dark d-flex justify-content-between">
					  <?php for ($k = 1;$k <= $columnCount;$k++) { ?>
							<div class="d-flex justify-content-center align-items-center  border-left td <?php echo $columnClass; ?> td-textarea">
								...
								<?php }else{?>
									<span class="textarea form-control form-control-textarea stringProper" role="textbox" contenteditable disabled placeholder="Write here..."><?php if ($answerExists) {
				...
				<?php }
					...
					<div class="d-flex justify-content-center align-items-center  border-left td <?php echo $columnClass; ?> td-textarea">
						...
						<?php } else { ?>
							<span class="textarea form-control form-control-textarea" role="textbox" contenteditable disabled placeholder="Write here..."><?php
								if ($answerExists) {
