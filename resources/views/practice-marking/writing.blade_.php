...
<form class="save_writing_at_end_up_form_{{$practise['id']}}">
                                                ...
                                                <p>
                                                    <div class="form-slider p-0 mb-4">
                                                        <div class="component-control-box">
                                                            <span class="textarea form-control form-control-textarea set_full_view_main stringProper test_4" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer'][$roleplayKey]) && $answerExists == true ? nl2br($practise['user_answer'][$roleplayKey]) : ''!!}</span>
                        ...
                        <div class="two-click-content w-100">
                            @foreach($roleplay as $key=> $roleplayQuestion)
                                <div class="content-box multiple-choice s-button-box selected_option_description selected_option_description_{{$key}} d-none" id="s-button-{{$key.''.$key}}">
                                    <div class="w-100">                                    
                                    <br>                                  
                                        <p class="">{!! str_replace('@@',' ',$roleplayQuestion) !!}</p>
                                        <p>
                                            <div class="form-slider p-0 mb-4">
                                                <div class="component-control-box">
                                                    <span class="textarea form-control form-control-textarea set_full_view_main stringProper stringProperNew test_1" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer'][$roleplayKey]) && $answerExists == true ? $practise['user_answer'][$roleplayKey] : ''!!}</span>
                                                    <input type="hidden" name="writeingBox[]" value="">
    ...
    @else
        @if(isset($practise['typeofdependingpractice']))
            @if(($practise['typeofdependingpractice'] === 'set_full_view_remove_zero'|| $practise['typeofdependingpractice'] ==="set_full_view" ) && $practise['type'] == 'Writing' )
                ...
                <p style="display: none;" id="set_full_view">
                    <div class="form-slider p-0 mb-4">
                        <div class="component-control-box">
                            <span class="textarea form-control form-control-textarea set_full_view stringProper" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? nl2br($practise['user_answer']) : ''!!}</span>
                ...
                @if(isset($practise['dependingpractise_answer'][0]) && !empty($practise['dependingpractise_answer'][0]))
                    ...
                    @endif
                        <p>                    
                            <div class="form-slider p-0 mb-4">
                                <div class="component-control-box">
                                    <span class="textarea form-control form-control-textarea stringProper" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? $practise['user_answer'] : ''!!}</span>
            ...
            <p>                    
                <div class="form-slider p-0 mb-4">
                    <div class="component-control-box">
                        <span class="textarea form-control form-control-textarea set_full_view_main stringProper test_2" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? nl2br($practise['user_answer']) : ''!!}</span>
                        <input type="hidden" name="writeingBox" value="{{ isset($practise['user_answer']) && $answerExists == true ? $practise['user_answer'] : ''  }}">
                    </div>
                </div>
            </p>
        ...
        @else
            ...
            @endif
                <div class="form-slider p-0 mb-4">
                    <div class="component-control-box">
                        <span class="textarea form-control form-control-textarea set_full_view_main stringProper test_3" role="textbox" contenteditable="" placeholder="Write here..." >{!! isset($practise['user_answer']) && $answerExists == true ? nl2br($practise['user_answer']) : ''!!}</span>
                        <input type="hidden" name="writeingBox" value="{{ isset($practise['user_answer']) && $answerExists == true ? $practise['user_answer'] : ''  }}">
                    </div>
                </div>
            </p>
    ...
    <ul class="list-inline list-buttons">
        <li class="list-inline-item"><button type="button" class="btn btn-secondary submitBtn writeAtendUpBtn_{{$practise['id']}}" data-pid="{{$practise['id']}}"
                data-toggle="modal" data-is_save="0" data-target="#exitmodal"  >Save</button>
        </li>
        <li class="list-inline-item"><button type="button"
                class="btn btn-secondary submitBtn writeAtendUpBtn_{{$practise['id']}}" data-pid="{{$practise['id']}}" data-is_save="1" >Submit</button>
        </li>
    </ul>
</form>
...
<script>
    ...
    if(data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_hide_show" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_parentextra" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_gen_que_double" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_remove_zero_parentextra_get_questions_and_answers" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_remove_zero" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_get_ans" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view" || data["{{$practise['id']}}"]["typeofdependingpractice"] =="set_full_view_remove_top_zero"){
        ...
        if(data["{{$practise['id']}}"]["dependant_practise_task_id"] == "{{request()->segment(3)}}"){
            ...
            data["{{$practise['id']}}"]["dependant_practise_task_id"] = "{{ $data[$practise['id']]['dependant_practise_task_id'] }}";
            data["{{$practise['id']}}"]["dependentURL"] = baseUrl+'/practice-detail/'+data["{{$practise['id']}}"]["dependant_practise_topic_id"]+'/'+data["{{$practise['id']}}"]["dependant_practise_task_id"]+'/{{$studentId}}?n='+data["{{$practise['id']}}"]["dependant_practise_id"];
            $.get(data["{{$practise['id']}}"]["dependentURL"],  //
            function (dataHTML, textStatus, jqXHR) {  // success callback
                console.log(dataHTML)
                if(iddata == "15508594835c703cdba98d1"){
                    data["{{$practise['id']}}"]["prevHTML"] = $(dataHTML).find('.course-tab-content').find('#abc-'+data["{{$practise['id']}}"]["dependant_practise_id"]).html();
                    $(document).find(".showPreviousPractice_"+data["{{$practise['id']}}"]["dependant_practise_id"]).html(data["{{$practise['id']}}"]["prevHTML"]);
                     $(".showPreviousPractice_"+data["{{$practise['id']}}"]["dependant_practise_id"]).find('.teacher-feedback-form').remove()
