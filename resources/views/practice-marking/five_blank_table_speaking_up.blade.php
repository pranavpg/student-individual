...
if(empty($practise['dependingpractiseid']) &&  empty($practise['is_dependent']) ){
	...
	if(isset($practise['is_roleplay']) && $practise['is_roleplay'] == 1){ ?>
    	...
    	<div class="table-container">
		    ...
		    <input type="hidden" class="deleted_audio_{{$practise['id']}}_0" name="delete" value="0">
	...
	<?php }?>
			...
			<?php }?>
					...
					<ul class="list-inline list-buttons">
						<li class="list-inline-item"><button type="button" class="btn btn-secondary submitBtn blankTableBtn_{{$practise["id"]}}" data-pid="{{$practise['id']}}"
