			...
			<div class="table-container mb-4 text-center">
				<div class="table m-auto">
					...
					if(isset($totalColumnCounts)){
						...
						<div class="table-row thead-dark d-flex justify-content-between" style="border-top: solid 1px #e0e2e4;">
												...
												<span class="textarea form-control form-control-textarea" role="textbox" disabled contenteditable placeholder="Write here...">
													<?php
														...
														if($practise['type'] == "one_blank_table"){
															...
															if($practise['type'] == 'two_blank_table_listening' && count($table_header) == 0 ){
																$newJ = $j;
...
?>
		<div class="table-container">
		    <form class="save_two_blank_table_form_{{$practise['_id']}}_{{$practise['_id']}}" id="blank_table_form_<?php echo $practise['id'];?>">
	        <input type="hidden" class="topic_id" name="topic_id" value="{{$topicId}}">
	        <input type="hidden" class="task_id" name="task_id" value="{{$taskId}}">
	        <input type="hidden" class="is_save" name="is_save" value="">
	        <input type="hidden" class="practise_id" name="practise_id" value="{{$practise['id']}}">
