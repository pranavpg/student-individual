...
if(empty($practise['dependingpractiseid']) &&  empty($practise['is_dependent']) ){
				...
				<div class="table m-auto">
					...
					if(isset($totalColumnCounts)){
						for ($j = 0;$j < $totalColumnCounts;$j++) {  
							$css="";
								if ($answerExists) { 
									if(!empty($practise['user_answer'][0][0][$j]['col_1']) ){
										$css="display:none";
									}
								} 
							?>
						<div class="table-row thead-dark d-flex justify-content-between" style="{{$css}}">
	...
	<?php }?>
			...
			<ul class="list-inline list-buttons">
				<li class="list-inline-item"><button type="button" class="btn btn-secondary blankTableBtn_{{$practise['id']}}" data-pid="{{$practise['id']}}"
								data-toggle="modal" data-is_save="0" data-target="#exitmodal">Save</button>
				</li>
				<li class="list-inline-item"><button type="button"
								class="btn btn-secondary submitBtn blankTableBtn_{{$practise['id']}}" data-pid="{{$practise['id']}}" data-is_save="1">Submit</button>
				</li>
			</ul>
		...
		?>
			...
			<?php }?>
					...
					<div class="alert alert-danger" role="alert" style="display:none"></div>
						...
						<ul class="list-inline list-buttons">
				<li class="list-inline-item"><button type="button" class="btn btn-secondary blankTableBtn_dependacy_{{$practise['id']}}" data-pid="{{$practise['id']}}"
								data-toggle="modal" data-is_save="0" data-target="#exitmodal">Save</button>
				</li>
				<li class="list-inline-item"><button type="button"
								class="btn btn-secondary submitBtn blankTableBtn_dependacy_{{$practise['id']}}" data-pid="{{$practise['id']}}" data-is_save="1">Submit</button>
				</li>
			</ul>
					<input type="hidden" name="table_type" value="<?php echo $columnCount; ?>" />
				</form>
