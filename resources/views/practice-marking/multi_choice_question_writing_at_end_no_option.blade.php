        ...
        @else
          <div class="choice-box">
              ...
              <div class="form-group"> 
                <span class="textarea form-control form-control-textarea stringProper" role="textbox"contenteditable placeholder="Write here...">@if($answerExists){{trim($practise['user_answer'][0][$key]['text_ans'])}}@endif</span>
