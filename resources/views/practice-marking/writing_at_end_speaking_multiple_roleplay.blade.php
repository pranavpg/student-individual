                    ...
                    if($value != ""){
                        ?>
                          ...
                          <p>{!!$value!!}</p>
                            ...
                            <span class="textarea form-control form-control-textarea stringProper" role="textbox" disabled contenteditable placeholder="Write here..."><?php if($answerExists && isset($practise['user_answer'][$txtwritingCount]['text_ans'])){echo($practise['type'] == "writing_at_end_speaking_multiple" || $practise['type'] == "speaking_writing")?$practise['user_answer'][$txtwritingCount]['text_ans']:$practise['user_answer'][0]['text_ans'][0];}?></span>
