...
<form class="form_{{$practise['id']}} commonFontSize">
  ...
  @endif
  <div class="writing_at_end" style="color:black !important;">
                                ...
                                echo $outValue = preg_replace_callback('/@@/', function ($m) use (&$key1, &$c_t, &$data, &$newTempAns, &$k, &$ans, &$s, &$key, &$user_answer, &$temp, &$tmprory) {
                                    ...
                                    if($ansd != ""){
                                        ...
                                        $str   .= '<div class="choice-box">
                                                '.$s.'. '.$ansd.'<div class="form-group"><span class="textarea form-control form-control-textarea main-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">'.$answers.'</span>
            ...
            // dd($practise);
                            ...
                            if(!str_contains($value,'&^')) {
                                ...
                                {{$value}}
                                    <div class="choice-box">
                                        <div class="form-group"><span class="textarea form-control form-control-textarea main-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">{{$answers}}</span>
                                            <div style="display:none">
                    ...
                    if(!empty($practise['dependingpractise_answer'])){
                        ...
                        foreach($question as $key => $value) {
                            ...
                            ?>
                                <div class="choice-box">
                                    <div class="form-group"><span class="textarea form-control form-control-textarea main-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">{{isset($user_answer[$w])?$user_answer[$w]:''}}</span>
                                        <div style="display:none">
                    ...
                    if(!empty($practise['dependingpractise_answer'])){
                        ...
                        foreach($question as $key => $value) {
                            if($newAns[$k]!=""){
                                ...
                                ?>
                                    <div class="choice-box">
                                        <div class="form-group"><span class="textarea form-control form-control-textarea main-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">{{isset($user_answer[$key])?$user_answer[$key]:''}}</span>
                                            <div style="display:none">
                    ...
                    echo $outValue = preg_replace_callback('/@@/', function ($m) use (&$key1, &$c_t, &$data, &$value, &$k, &$ans) {
                            ...
                            if(empty($ans)){
                                $str.= '<span class="resizing-input1">
                                          <span readonly disabled contenteditable="false" class="enter_disable spandata fillblanks stringProper disable_writing"></span>
                                ...
                                $str.= '<span class="resizing-input1">
                                          <span readonly disabled contenteditable="false" class="enter_disable spandata fillblanks stringProper disable_writing">'.$apval.'</span>
                    ...
                    echo $outValue = preg_replace_callback('/@@/', function ($m) use (&$key1, &$c_t, &$data, &$value, &$k, &$ans, &$key) {
                            ...
                            $str   .= '<div class="choice-box j">
                                            <div class="form-group">
                                                <span class="textarea form-control form-control-textarea main-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">'.$answeres.'</span>
                                                <div style="display:none">
        ...
        if(!empty($practise['dependingpractise_answer'])){
            ...
            foreach($ans as $newdata){
                ...
                if(!empty($user_answer)) {
                    ...
                    foreach($user_answer as $key => $value) { ?>
                            <span class="textarea form-control form-control-textarea main-answer enter_disable" role="textbox" disabled contenteditable placeholder="Write here...">{{$value}}</span>
                            <div style="display:none">
                   ...
                   <?php } 
                    ...
                    foreach($newAns as $key => $value) { ?>
                        <?php 
                        if($value!="test"){?>
                            <span class="textarea form-control form-control-textarea main-answer enter_disable" role="textbox"  disabled contenteditable placeholder="Write here...">{{$question[$key].''.$question2[$value]}}</span>
                            <div style="display:none">
                                    <textarea name="user_answer[0][]" class="main-answer-input">{{$question[$key].''.$question2[$value]}}</textarea>
                            </div>   
                            
                            <span class="textarea form-control form-control-textarea main-answer enter_disable" role="textbox" disabled contenteditable placeholder="Write here..."></span>
                            <div style="display:none">
            ...
            if($practise['depending_practise_details']['question_type'] == "writing_at_end_speaking_multiple_up") {
                ...
                $user_answer = [];
                   ...
                   $k=0;
                   foreach($question as $key => $value) {
                        if($practise['id'] =="15713520695da8ee05c52a1"){
                            echo $value." : ".$question2[$key];
                        }else{
                        ...
                        ?>
                            <div class="choice-box j">
                                <div class="form-group">
                                    <span class="textarea form-control form-control-textarea main-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">{{isset($user_answer[$key])?$user_answer[$key]:''}}</span>
                                    <div style="display:none">
                                        <textarea name="user_answer[0][{{$key}}]" class="main-answer-input">{{isset($user_answer[$key])?$user_answer[$key]:''}}</textarea>
                                    </div>
                                </div>
            ...
            if($practise['depending_practise_details']['question_type'] == "listening_writing"){
                    ...
                    foreach($prctice as $key=>$ans){
                        ...
                        <div class="form-slider p-0 mb-4">
                          <div class="component-control-box">
                                      <span class="textarea form-control" disabled role="textbox" disabled contenteditable="false" placeholder="Write here..." name="writeingBox" value="writeingBox" onpaste="return false;">{{$ans}}</span>
                            <div style="display:none">
                    ...
                    foreach($question as $key => $value) {
                        ...
                        if(str_contains($value,'@@')) {
                            echo $outValue = preg_replace_callback('/@@/', function ($m) use (&$kley1, &$c_t, &$data, &$value, &$j, &$ans, &$user_answer, &$dependAns) {
                                    ...
                                    $str.= '<span class="textarea form-control form-control-textarea maiDn-answer enter_disable another-main-answer stringProper" role="textbox" disabled contenteditable placeholder="Write here...">'.$apval.'</span><div style="display:none"><textarea name="user_answer[]" class="main-answer-input"></textarea></div>'; 
                ...
                if(isset($practise['dependingpractise_answer']) && !empty($practise['dependingpractise_answer'])) {
                    ...
                    foreach($prctice as $key=>$ans){
                        if($ans=="")continue; ?>
                        <div class="choice-box">
                              <p class="mb-0"> <span class="textarea form-control form-control-textarea main-answer enter_disable" role="textbox" disabled contenteditable placeholder="Write here...">{!! $ans !!}</span> </p>
                    ...
                    foreach($question_new as $key => $value) {
                        if(str_contains($value,'@@')) {
                            echo $outValue = preg_replace_callback('/@@/', function ($m) use (&$kley1, &$c_t, &$data, &$value, &$j, &$newans, &$user_answer) {
                                    ...
                                    $str.= '<span class="textarea form-control form-control-textarea maiDn-answer enter_disable another-main-answer" role="textbox" disabled contenteditable placeholder="Write here...">'.$apval.'</span><div style="display:none"><textarea name="user_answer[]" class="main-answer-input"></textarea></div>'; 
                     ...
                     if(count($tapscript)>1) {
                        ...
                        { ?>
                          <div  style="text-align: center;margin-bottom: 27px;">
                            <button id="openmodel" class=" openmodel btn btn-primary" style="pointer-events: auto;">{{$tapscript[0]}}</button>
                          </div>
                         <?php
                        }
                      }
