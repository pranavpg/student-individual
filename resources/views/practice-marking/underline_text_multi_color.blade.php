...
$(document).ready(function(){
  ...
  // alert(('#abc-'+pid))
  $('#abc-'+pid).find('.underline_text_list_item').each(function(key){
    // if(k>0){
    //   k=k+1;
    // }
            ...
            // console.log(key,'===>k', value)
             if(k=='fColor'){
                ...
                if(v =='-1758164' || v== '-1145286'){
                  $('#abc-'+pid).find('.q0').find('#'+value.i).addClass('bg-success1');

                  // $('#abc-'+pid).find('.q0').find('#'+value.i).css('background-color',"");
                  $('#abc-'+pid).find('.q0').find('#'+value.i).css('background-color',colorsArray[0]);
                  // $(this).css('background-color',colorsArray[0]);

                } else {
                  $('#abc-'+pid).find('.q0').find('#'+value.i).addClass('bg-opinion');
                  $('#abc-'+pid).find('.q0').find('#'+value.i).css('background-color',colorsArray[1]);
                }
               $('#abc-'+pid).find('.q0').find('#'+value.i).attr('fColor',v)
               $('#abc-'+pid).find('.q0').find('#'+value.i + ' .fColor').attr('value',v)
             }
             $('#abc-'+pid).find('.q0').find('#'+value.i).find('input').removeAttr('disabled');
          });
          $l++
      });
    }
