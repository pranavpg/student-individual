      ...
      <div class="component-two-click mb-4" >
    	...
    	<ul class="list-inline list-buttons dependancy_button">
    	    <li class="list-inline-item">
                <input type="button" class="btn btn-secondary submitBtn true_false_submitBtn_{{$practise['id']}}" data-is_save="0" value="Save">
    	    </li>
    	    <li class="list-inline-item">
                <input type="button" class="btn btn-secondary submitBtn true_false_submitBtn_{{$practise['id']}}" data-is_save="1" value="Submit">
    	    </li>
    	</ul>
    </form>
