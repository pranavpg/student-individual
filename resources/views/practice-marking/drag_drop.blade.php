...
<form class="form_{{$practise['id']}}">
  ...
  <ul class="list-inline list-buttons">
      <li class="list-inline-item"><a href="javascript:void(0);" class="btn btn-secondary submitBtn"
              data-toggle="modal" data-target="#exitmodal">Save</a>
      </li>
      <li class="list-inline-item"><a href="javascript:void(0);"
              class="btn btn-secondary submitBtn">Submit</a>
      </li>
  </ul>
		  ...
		  $.ajax({
			  ...
			  success: function (data) {
					...
					if(data.success){
						...
						$('.form_<?php echo $practise['id'];?> .alert-success').show().html(data.message).fadeOut(4000);
					}else{
						$('.form_<?php echo $practise['id'];?> .alert-success').hide();
						$('.form_<?php echo $practise['id'];?> .alert-danger').show().html(data.message).fadeOut(4000);
					}
			  }
		  });
