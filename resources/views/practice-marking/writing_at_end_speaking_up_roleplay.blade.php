                      ...
                      if($value != "" && str_contains($value,'@@')){
                        ?>
                         ...
                         <p>{!!str_replace('@@','',$value)!!}</p>
                            ...
                            <span class="textarea form-control form-control-textarea stringProper" role="textbox" disabled contenteditable placeholder="Write here..."><?php if(isset($practise['user_answer'][$answer_count]['text_ans'][$key])){echo $practise['user_answer'][$answer_count]['text_ans'][$key];}?></span>
                            <div style="display:none">
                                    <textarea name="user_answer[{{$answer_count}}][text_ans][{{$key}}]" disabled="true">
                                    <?php
