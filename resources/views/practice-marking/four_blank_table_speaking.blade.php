			...
			<?php }?>
					...
					<!-- <ul class="list-inline list-buttons">
						<li class="list-inline-item">
								...
								<input type="button" class="blankTableBtn_{{$practise['id']}} btn btn-secondary" value="Save" data-is_save="0">
						</li>
						<li class="list-inline-item">
						<input type="button" class="blankTableBtn_{{$practise['id']}} btn btn-secondary" value="Submit" data-is_save="1">
