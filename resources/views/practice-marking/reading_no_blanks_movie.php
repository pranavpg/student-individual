...
?>
    ...
    <div class="table-container">
      <form class="reading-no-blanks_form_<?php echo $practise['id'];?>">
		...
		foreach($exploded_question as $key=>$question){
			...
			$question = str_replace("@@",'<span class="resizing-input '.$key.'"><input type="text" class="form-control form-control-inline" name="blanks[]" style="text-align:left;padding-left:0px;padding-right:0px;" value="'.$value.'"><span style="display:none"></span></span>',$question);
			?>
	...
	<p><a href="javascript:void(0);" id="show_hide_movie" class="btn btn-dark" style="pointer-events:auto;">Hide</a></p>
