        ...
        <div class="tab-pane fade show active" id="abc-b" role="tabpanel"
            ...
            <p><strong>Write or Paste your url below:</strong></p>
             ...
             <div class="record-video d-flex align-items-end mb-4">
                <b>www.</b>
                <span class="textarea form-control form-control-textarea enter_disable" role="textbox" contenteditable="" placeholder="Write here...">
                    {{ $answerExists }}
                </span>
           ...
           <!--  <li class="list-inline-item">
                <input type="button" class="record_video_form_{{$practise['id']}} btn btn-secondary" value="Save" data-is_save="0">
                </li>
                <li class="list-inline-item">
                <input type="button" class="record_video_form_{{$practise['id']}}  btn btn-secondary" value="Submit" data-is_save="1">
                </li>
            </ul> -->
        </div>
</form>
    ...
    $.ajax({
        ...
        success: function (data) {
          ...
          if(data.success){
            ...
            $('.alert-success').hide();
            $('.alert-danger').show().html(data.message).fadeOut(4000);is_save
          }
