...
if(isset($practise['is_dependent']) && !empty($practise['is_dependent']) && $practise['is_dependent'] == true && isset($practise['dependingpractiseid']) && isset($practise['typeofdependingpractice']) && $practise['typeofdependingpractice']=="get_answers_put_into_quetions" ){
							...
							<div class="d-flex justify-content-center align-items-center  border-left td <?php echo $columnClass; ?> td-textarea">
								...
								<?php }else{?>
									...
									<span class="textarea form-control form-control-textarea" role="textbox" contenteditable placeholder="Write here...">
										...
										<?php
										// echo '<pre>';
										// print_r($practise['user_answer']);die;
									    if ($answerExists) {
													if(isset($practise['user_answer'][0][0][$j + 1]['col_' . $k])){
														echo $practise['user_answer'][0][0][$j + 1]['col_' . $k];
													}
													// else if( !empty($practise['user_answer'][0]['text_ans'][0][$j + 1]['col_' . $k]) && is_array($practise['user_answer'][0]['text_ans'][0][$j + 1]['col_' . $k]) ){
													// 		echo $practise['user_answer'][0]['text_ans'][0][$j + 1]['col_' . $k];
													// }
													else if(!empty($practise['user_answer'][0]['text_ans'][0][$j + 1]['col_' . $k])){
															echo $practise['user_answer'][0]['text_ans'][0][$j + 1]['col_' . $k];
													}
					            }
										?>
...
<?php }?>
		...
		<?php /*?><ul class="list-inline list-buttons">
			<li class="list-inline-item"><a href="#!" class="btn btn-secondary"
					data-toggle="modal" data-target="#exitmodal">Save</a>
			</li>
			<li class="list-inline-item"><a href="#!"
					class="btn btn-secondary">Submit</a>
			</li>
		</ul><?php */ ?>
