...
<form class="form_{{$practise['id']}}">
        ...
        <?php $answer_count =$roleplayCount= 0; $txtwritingCount = 0; ?>
          ...
          @foreach($explode_question as $k => $v)
            ...
            <div class="form-group">
                      <span class="textarea form-control form-control-textarea stringProper enter_disable" role="textbox" contenteditable placeholder="Write here..."><?php if (isset($practise['user_answer'][$answer_count][0][0]) && !empty($practise['user_answer'][$answer_count][0][0])) { echo ($practise['user_answer'][$answer_count][0][0]); } ?></span>
  ...
  <!-- <ul class="list-inline list-buttons">
      <li class="list-inline-item"><button type="button" class="btn btn-secondary submitBtn writing_at_end_up_speaking_up" data-pid="{{$practise['id']}}"
              data-toggle="modal" data-is_save="0" data-target="#exitmodal"  >Save</button>
      </li>
      <li class="list-inline-item"><button type="button"
              class="btn btn-secondary submitBtn writing_at_end_up_speaking_up" data-pid="{{$practise['id']}}" data-is_save="1"  >Submit</button>
      </li>
  </ul> -->
</form>
<script>
