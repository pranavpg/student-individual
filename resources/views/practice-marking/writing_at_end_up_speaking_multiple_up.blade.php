				...
				@if(!empty($value))
					...
					@endif
						<div class="{{$div_span}}">
							...
							@endif
							<span class="textarea form-control form-control-textarea stringProper" role="textbox"contenteditable placeholder="Write here..."><?php if ($answerExists){echo  $practise['user_answer'][$key]['text_ans'];}?>
							</span>
