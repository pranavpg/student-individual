              ...
              <div class="content-box multiple-choice d-none selected_option_description selected_option_description_{{$count}}" >
                ...
                @foreach($q_value as $k=>$v)
                  ...
                  <div class="form-group">
                    <span class="textarea form-control form-control-textarea main-answer stringProper enter_disable" role="textbox" contenteditable placeholder="Write here..."><?php if ($answerExists) { echo  !empty($answers[$j]['text_ans'][$kk])?nl2br($answers[$j]['text_ans'][$kk]):"";}?></span>
