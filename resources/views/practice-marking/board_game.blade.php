...
<p>
    ...
    <div class="table-container" style="pointer-events: auto;">
		...
		<div class="container">
			...
			?>
				<div class="col-sm-3" style="margin-bottom:20px;" style="pointer-events: auto;">
					...
					<?php if(!empty($curMaterials[4])){?>
						...
						<div class="modal " id="practise_block_<?php echo $practise['id'];?>_<?php echo $i;?>">
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="table-slider-box ietsb-mobv text-center d-flex flex-wrap">
																...
																<div class="w-33 ietsob-mobv table-option border-right border-bottom">
...
<script>
    ...
    //         e.preventDefault();
    //         $('.alert-success').show().html("All answers successfully submitted.").fadeOut(4000);
    //     })
    // })
