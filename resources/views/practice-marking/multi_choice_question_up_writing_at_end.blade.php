          ...
          @foreach($exploded_question as $key => $question)
                <div class="multiple-choice">
                    ...
                    <div class="multiple-check d-flex flex-wrap mb-0">
                      ...
                      <div class="custom-control custom-checkbox mb-1 w-33 mr-0">
        ...
        <!-- <ul class="list-inline list-buttons">
            <li class="list-inline-item">
              <a href="#!" class="btn btn-secondary"
                    ...
                    <input type="button" class="multiChoiceQwritingEndBtn_{{$practise['id']}} btn btn-secondary" value="Save" data-is_save="0">
            </li>
            <li class="list-inline-item">
             <input type="button" class="multiChoiceQwritingEndBtn_{{$practise['id']}} btn btn-secondary" value="Submit" data-is_save="1">
