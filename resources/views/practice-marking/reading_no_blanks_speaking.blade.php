					...
					<div class="component-two-click mb-4">
						<div class="two-click d-flex flex-wrap justify-content-center mb-4 w-100">
							...
							foreach($rolePlayUsers as $c=>$rolePlayUser){ ?>
								<a href="#!" id="s-button-<?php echo $c;?>" class="btn btn-dark s-button" style="pointer-events: auto;"><?php echo trim($rolePlayUser);?></a>
							<?php }?>
						</div>
...
$(function () {
	// two click js
	$("#abc-<?php echo $practise['id'];?> .s-button").on("click",function(){
		if($("#abc-<?php echo $practise['id'];?> .s-button.d-none").length > 0){
			$("#abc-<?php echo $practise['id'];?> .s-button.d-none");
			$("#abc-<?php echo $practise['id'];?> .s-button-box").addClass("d-none");
			$("#abc-<?php echo $practise['id'];?> .s-button").removeClass("d-none").removeClass("btn-bg");
			return false;
		}
		$("#abc-<?php echo $practise['id'];?> .s-button-box,.s-button").addClass("d-none");
		$(this).removeClass("d-none").addClass("btn-bg");
		var curId = $(this).attr("id");
		curId = curId.replace("s-button-","");
		$("#abc-<?php echo $practise['id'];?> #s-button-"+curId+curId).removeClass("d-none");
	})
...
$( document ).ready(function() {
  ...
  if(practise_id){
  	if(practise_id == '15506731365c6d64f09651a')
  	{
