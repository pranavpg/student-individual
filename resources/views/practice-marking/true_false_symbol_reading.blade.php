                    ...
                    <div class="box box-flex d-flex align-items-center">
                        <div class="box__left box__left_radio">
                              ...
                              if(strpos($item,"Answer:") || strpos($item, "Question: :") || strpos($item,"Question:")){
                                ...
                                $str ='Question: <span class="resizing-input1"><span disabled contenteditable="false" class="enter_disable spandata fillblanks stringProper" style="color: #03A9F4">'.$valSpace1.'</span></span>?<br />Answer:';
                                ...
                                $str ='<span class="resizing-input1"><span disabled contenteditable="false" style="text-color:#03A9F4" class="enter_disable spandata fillblanks stringProper">'.$andVal.'</span></span>';
