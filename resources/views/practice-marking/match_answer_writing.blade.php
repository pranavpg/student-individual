...
<form class="save_match_answer_writing_{{$practise['id']}}">
    ...
    <ul class="list-inline list-buttons">
        <li class="list-inline-item">
            <button type="button" class="btn btn-secondary submitMatchAnswerWritingBtn_{{$practise['id']}}" data-toggle="modal" data-is_save="0" data-target="#exitmodal">Save</button>
        </li>
        <li class="list-inline-item">
            <button type="button" class="btn btn-secondary submitMatchAnswerWritingBtn_{{$practise['id']}}" data-toggle="modal" data-is_save="1" data-target="#exitmodal" >Submit</button>
        </li>
    </ul>
</form>
    ...
    $(".save_match_answer_writing_{{$practise['id']}}").find('.question_option').on('click', function() {
        ...
        else
        {
            ...
            $(".save_match_answer_writing_{{$practise['id']}}").find('.answer_option').on('click', function() {
                ...
                var chosen_option = $(".save_match_answer_writing_{{$practise['id']}}").find('.question_option.active-bg').attr('data-bgcolor');
                ...
                //var selected_answer = $(".save_match_answer_writing_{{$practise['id']}}").find('.question_option.'+chosen_option).attr('data-key');
                var selected_question = $('.question_option.active-bg').attr('data-key');
                var selected_answer = parseInt(  $(this).data('key') );
                $('.hidden:eq('+selected_question+')').val("");
                $('.hidden:eq('+selected_question+')').val(selected_answer);
                }
                } else {
                    $('.alert-success').hide();
