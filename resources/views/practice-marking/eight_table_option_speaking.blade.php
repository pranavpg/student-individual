									...
									<?php }else { ?>
										...
										<?php if($practise['type'] == "six_blank_table_true_false"){
											...
											<div class="custom-control custom-checkbox custom-checkbox_single  {{$current_class}}">
		                                        ...
		                                        <input name="col[<?php echo $countElement;?>]" type="checkbox" disabled class="custom-control-input" id="cc<?php echo $k.$j;?>" value="{{$check_value}}" <?php if($checked){?> checked="checked" <?php }?>>
