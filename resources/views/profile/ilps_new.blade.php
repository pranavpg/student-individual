   ...
   <div class="filter-body">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 partA">
            ...
            <div class="custom-control custom-radio">
               <input type="radio" class="custom-control-input" id="teacher_led" name="led" value="a">
               <label class="custom-control-label" for="teacher_led">Teacher Led</label>
            </div>
         </div>
         <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 partA">
                  ...
                  <div class="row">
                     <div class="col-12 col-sm-7 col-md-6 col-lg-8 col-xl-8 d-none d-sm-block d-xl-none notes-selection">
                        <select class="col-md-6 custom-select2-dropdown-nosearch" id="led_search">
                           ...
                           <option value="t_led">Teacher Led</option>
                        </select>
                     </div>
                     <div class="col-12 col-sm-6 col-md-6 col-lg-8 col-xl-8 d-none d-xl-block">
                        <ul class="nav nav-pills nav-pills_switch clickled" id="pills-tab" role="tablist">
                           ...
                           <li class="nav-item">
                              <a class="nav-link teach" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" id-data="teach">Teacher Led</a>
                           </li>
                        </ul>
                     </div>
            ...
            <div class="main__content ieuk-ilpm pt-3">
               <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                     ...
                     <table class="table work-record__table ieuktable-sline table2" id="teacher-led">
                        <thead class="thead-dark">
                           <tr>
                              <th scope="col">Created On</th>
                              <th scope="col" width="45%">Target</th>
                              <th scope="col" width="22%">Next Review Date</th>
                              <th scope="col">Action</th>
                           </tr>
                        </thead>
                        <tbody>
                           <?php foreach($teacher_ilps as $teacher_ilp){?>
                           <tr>
                              <td><?php echo date("d-m-Y",strtotime($teacher_ilp['created_at']));?></td>
                              <td><?php echo $teacher_ilp['end_target'];?></td>
                              <th scope="row"><?php echo date("d-m-Y",strtotime($teacher_ilp['new_next_review_date']));?></th>
                              <td>
                                 <a href="javascript:void(0)">
                                 <img src="{{ asset('public/images/icon-small-eye.png')}}" width="26px" alt="" class="img-fluid openmodel" data-classname ="{{$teacher_ilp['class_name']}}" data-lerining="{{$teacher_ilp['learning_style']}}" data-next="{{$teacher_ilp['new_next_review_date']}}" data-usefull="{{$teacher_ilp['useful_ways']}}" data-strengths="{{$teacher_ilp['strengths']}}" data-weakness="{{$teacher_ilp['weakness']}}" data-current_date="{{$teacher_ilp['current_date']}}" data-end_target="{{$teacher_ilp['end_target']}}">
                                 </a>
                              </td>
                           </tr>
                           <?php }?>
...
$(document).ready(function(){
	...
	if(submitFlag){
		...
		$.ajax({
			url: "{{URL('profile/add_edit_ilp_new')}}",
...
// 		$(".delete_ilp_form").find("input[type='submit']").prop("disabled",true);
// 		$(".delete_ilp_form").find("button[type='submit']").prop("disabled",true);
// 		$.ajaxSetup({
// 			headers: {
...
// 			type: "POST",
// 			url: '{{ URL("profile/add_edit_ilp_new") }}',
// 			data : $(".delete_ilp_form").serialize(),
// 			dataType: "json",
// 			success: function(res) {
// 				if(res.success){
// 					window.location.reload();
// 				}else{
// 					$(".delete_ilp_form").find("input[type='submit']").prop("disabled",false);
// 					$(".delete_ilp_form").find("button[type='submit']").prop("disabled",false);
...
<script type="text/javascript">
	...
	$(document).on('change',"#teacher_led",function(){
		...
		$("#led_search [value='"+'t_led'+"']" ).prop('selected', true);
